...
# Secret key — set MW_SECRET_KEY env var (generate: openssl rand -hex 32)
$wgSecretKey = getenv('MW_SECRET_KEY') ?: 'not-configured-set-MW_SECRET_KEY-env-var';
...
# Upgrade key — set MW_UPGRADE_KEY env var if using the web installer
$wgUpgradeKey = getenv('MW_UPGRADE_KEY') ?: 'not-configured-set-MW_UPGRADE_KEY-env-var';
